...
if question1 == "yes" or question1 == "Yes":
    ...
    print("This is where everything is upside down and laughter is guaranteed.")
    print("Now let's throw in some words.")
elif question1 == "no" or question1 == "No":
    print("Too bad! You can always come back later. Have a nice day!")
    exit()
...
input6 = input("One more plural substantive!: ")
